...
def main():
	...
	#X_train['Payment Term'] = X_train['Payment Term'].astype('int')
    #X_test['Payment Term'] = X_test['Payment Term'].astype('int')

    model_list = [logr, rr, dt, ad, nb, kn]
    scores = []
    model_objects = {}
    for x in model_list:
    ...
    names = ['Log', 'RF', 'DT', 'Adaboost', 'NaiveBayes', 'KNN']
    ...
    hyperparameter_space = {'max_depth':[None,4,6,8],'min_samples_leaf':[1, 2, 4]}
